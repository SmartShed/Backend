...
const createDraft = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ status: "success", message: "Draft Saved Successfully" });
    }
    catch (err) {

        return res.status(500).json({ status: "error", message: "Draft saving failed" });
    }
}
...
const submitForm = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ status: "error", message: "Form submission failed" });
    }
