...
const getAllUnSignedForms = async (req, res) => {
    try {
        let forms = await Form.find({
            "signedBySupervisor.isSigned": true, "signedByAuthority.isSigned": false
        }).populate('createdBy').populate('signedBySupervisor');
...
const getSignedFormsOfAuthority = async (req, res) => {
    try {
        ...
        }).populate('createdBy').populate('signedBySupervisor.supervisor').populate('signedByAuthority.authority');
